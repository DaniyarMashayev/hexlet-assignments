...
public class PostsController {
    ...
    public static void edit(Context ctx) {
        ...
        EditPostPage page = new EditPostPage(post.getId(), post.getName(), post.getBody(), Collections.emptyMap());
    ...
    public static void update(Context ctx) {
        ...
        try {
            ...
            String body = ctx.formParamAsClass("body", String.class)
                    .check(value -> value.length() >= 10, "Posts must be no shorter than 10 characters")
                    .get();
